...
//    @Log(title = "用户管理", businessType = BusinessType.INSERT)
    @AuditOperation("@audit.auditRecord(" +
            "T(com.biz.constant.enums.AuditEnums).SYSTEM_USER_CREATE, " +
...
//    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @AuditOperation("@audit.auditRecord(" +
            "T(com.biz.constant.enums.AuditEnums).SYSTEM_USER_EDIT, " +
            "#spelReturnValue, #request, #loginUser, " +
            "#user)")
    @PutMapping()
...
//    @Log(title = "用户管理", businessType = BusinessType.DELETE)
    @AuditOperation("@audit.auditRecord(" +
            "T(com.biz.constant.enums.AuditEnums).SYSTEM_USER_DELETE, " +
            "#spelReturnValue, #request, #loginUser, " +
            "#userIds)")
