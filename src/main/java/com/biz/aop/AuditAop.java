...
import com.biz.mvc.exception.AbstractBusinessException;
import com.biz.mvc.response.BaseResponseBodyAdvice;
import com.biz.mvc.response.annotation.WrapperResponseAdvice;
import com.biz.mvc.vo.ResponseResult;
import com.biz.util.SpelParserUtils;
...
public class AuditAop {
    ...
    @Around(value = "@annotation(com.biz.aop.AuditOperation)", argNames = "pjp")
