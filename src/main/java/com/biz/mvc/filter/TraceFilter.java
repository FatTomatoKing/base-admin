...
public class TraceFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        // 将 traceId 放入 MDC
        MDC.put(WebBizConstants.TRACE_ID, traceId + "");
        response.setHeader(WebBizConstants.TRACE_ID, traceId + "");
        request.setAttribute(WebBizConstants.TRACE_ID, traceId);
        ...
        try {
            ...
            MDC.remove(WebBizConstants.TRACE_ID);
        }
    }
}
